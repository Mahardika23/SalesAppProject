                            ...
                            <div class="row no-gutters" style="padding-right:15;">
                                ...
                                <div class="col-7">
                                    <div class="card-body p-2" id="{{$barang['id']}}isi">
                                        <p id="distributor" hidden style="padding-left:20%; margin-bottom:3; font-size:150%;">{{$data['nama_distributor']}}</p>
                                        ...
                                        <form class="card-text">
                                            ...
                                            <p class="m-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">: <text id='stok'> {{$barang['stok_barang']}}</text> </div>
                                                </div>
                                            </p>
                                        </form>
