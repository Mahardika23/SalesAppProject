            ...
            <div class="col-lg-8">
                <div class="card mt-5">
                    <div class="card-body" style="text-align:center">
                        ...
                        <form action="/daftar/alamat" method="get" style='text-align:left'>
                        <div style='margin-left:10%;margin-right:10% '>
                            <div class="form-group row">
                                <label for="nama_toko" class="col-sm-3 col-form-label">Nama Toko</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_toko" placeholder="" autocomplete='off'>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama_pemilik" class="col-sm-3 col-form-label">Nama Pemilik</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_pemilik" placeholder="" autocomplete='off'>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email_pemilik" class="col-sm-3 col-form-label">Email Pemilik</label>
                                <div class="col-sm-9">
                                <input type="email" class="form-control" id="email_pemilik" placeholder="" autocomplete='off'>
                                </div>
                            </div>
                            <div class="form-group row">
