                ...
                <div class="card p-0">
                    ...
                    <div class="card-body">
                        <div class="row ml-2">
                            ...
                            <input type="hidden" name="pemesanan_id" value=1>
                                    ...
                                    <div class="card mb-4" style=" background-color: rgb(239, 233, 252); max-width: 30rem; max-height:11rem;">
                                        <div class="row no-gutters" style="padding-right:15;">
                                            ...
                                            <div class="def-number-input number-input safari_only col-4" style="padding-top:17%;">
                                                ...
                                                <input class="quantity" min="0" name="kuantitas_barang" value="{{$barang['quantity']}}" type="number">
                            ...
                            <input type="hidden" name="total_harga" value=1>
                            <input type="hidden" name="kuantitas_pesanan" value=1>
                            @endforeach
                        </div>
                    </div>
                </div>
