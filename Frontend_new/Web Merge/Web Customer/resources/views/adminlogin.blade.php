...
<body>
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="  needs-validation login100-form needs-validation" method="POST"
                action="/logincheck-distributor" novalidate>
                @CSRF
    ...
    <div class="modal fade" id="loginfailed" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
