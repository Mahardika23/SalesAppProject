...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/admin-app.css') }}" />

    <link rel="stylesheet" type="text/css" href="{{ url('/css/admin-sidebar.css') }}" />
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                        ...
                        <form action="/Ubah-Password" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="current_password" placeholder="Password lama" require>
                            </div>
                            <div class="form-group">
